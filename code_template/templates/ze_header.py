...
#ifndef ZE_${FILENAMECAP}_${FILEENDINGCAP}_INCLUDED
#define ZE_${FILENAMECAP}_${FILEENDINGCAP}_INCLUDED
...
#endif // ZE_${FILENAMECAP}_${FILEENDINGCAP}_INCLUDED
"""



class ze_header( code_template_helpers.APlugin ):
    ...
    def do_work( self , args , replacements ):
        ...
        code_template_helpers.add_namespace_replacements( replacements , args , [ "ZE" ] )
